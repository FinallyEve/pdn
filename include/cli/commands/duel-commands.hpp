...
/**
 * Duel-related commands for CLI simulator.
 * Handles duel history, records, series tracking, and rematch functionality.
 */
class DuelCommands {
public:
    /**
     * Duel history and statistics commands.
     * Usage: duel history [count] | duel record [opponent] | duel series
     */
    ...
    static CommandResult cmdRematch(const std::vector<std::string>& tokens,
        ...
        int opponentIdx = findDeviceFunc(lastOpponent, devices, -1);
